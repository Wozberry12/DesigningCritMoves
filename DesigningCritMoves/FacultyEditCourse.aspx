...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <section class="w-50 mt-2 text-center" style="margin-left:auto; margin-right:auto;">
                    ...
                    <br />
                    <asp:Button id="btnSaveEdit"  Text="SAVE COURSE" runat="server" cssclass="btn btn-primary mb-2 fs-4 fw-bolder w-75" style="background-color: #FF6555; margin-right: auto; margin-left:auto;" OnClick="btnSaveEdit_Click"/>
                    <%--<asp:Button Text="SAVE COURSE" runat="server"    OnClick="btnSaveEdit_ServerClick"/>--%>
                </section>
