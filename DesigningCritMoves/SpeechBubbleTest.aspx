...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="cardContainerOne" class="card-holder text-center">
        <div id="cardOne" class="card bg-transparent container-speech-bubble-container justify-content-center">
            <div class="front">
                <div class="container container-speech-bubble-container">
                    <section class="speech-bubble align-content-center h-100">
                        <div class="card-title card-header-custom w-50 text-capitalize">Composition</div>
            ...
            <div class="back h-100">
                <div class="container container-speech-bubble-completed h-75">
        ...
        <div id="cardContainerTwo" class="text-center border-0">
        <div id="cardTwo" class="card bg-transparent container-speech-bubble-container  justify-content-center">
            <div class="front">
                <div class="container container-speech-bubble-container">
                    <section class="speech-bubble align-content-center h-100">
                        <div class="card-title card-header-custom w-50 text-capitalize">General</div>
                        <div class="card-text card-text-custom-padding container-prompt-content text-center">Refer back to your peer's work from a previous class and share how their previous round of work might have been more successful.</div>
                        <div class="row">
                            <div class="container container-prompt-pass text-center w-25">Pass</div>
                            <div class="container container-prompt-complete text-center w-50">
