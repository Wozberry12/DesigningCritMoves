        ...
        <header class="py-0 mb-0">
            ...
            <div class="d-flex position-absolute top-0 end-0" style="padding-top: 2em; padding-right: 2em;">
                ...
                <section class="w-50 mt-2 text-center" style="margin-left:auto; margin-right:auto; ">
                    ...
                    <asp:TextBox class="modifyStudentTextbox" runat="server" Style="width: 75%; margin-right: auto; margin-left:auto; margin-top: 3%; border-radius: 15px; " BorderStyle="None" CssClass="form-control" placeholder="Course Name" />
                    <br />
