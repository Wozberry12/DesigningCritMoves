        ...
        <header class="py-0 mb-0">
            ...
            <div class="d-flex position-absolute top-0 end-0" style="padding-top: 2em; padding-right: 2em;">
                ...
                <section class="w-50 mt-2 text-center" style="margin-left:auto; margin-right:auto; ">
                    ...
                    <br />
                    <button type="submit" class="btn btn-primary mb-2 fs-4 fw-bolder w-75" style="background-color: #FF6555; margin-right: auto; margin-left:auto" id="1">CREATE COURSE</button>
                </section>
